...
namespace TechEasy.CommandProcessor.Dispatcher
{
    ...
    {
        public ICommandResult Submit<TCommand>(TCommand command) where TCommand : Command.ICommand
        {
        ...
        public IEnumerable<ValidationResult> Validate<TCommand>(TCommand command) where TCommand : Command.ICommand
        {
